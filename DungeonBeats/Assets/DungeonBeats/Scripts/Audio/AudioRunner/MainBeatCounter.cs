...
public class MainBeatCounter : MonoBehaviour {

    public static MainBeatCounter Instance;
    ...
    public int beatsCountInSequence;
    [HideInInspector]
    public int currentBeat;
    [HideInInspector]
    public int beatInSequence;
    ...
    IEnumerator BeatCheck()
    {
        while (audioSource.isPlaying)
        {
            ...
            if (currentSample >= (nextBeatSample + sampleOffset))
            {
                ...
                // FIRE BEAT TICK EVENT
                GameEvents.BeatTickEvent(currentBeat, beatInSequence);
                currentBeat++;
